...
export class RecipeService {
  ...
  public createRecipe(title: string, description: string, serves: string,
                      imageUrl: string, ingredients: IIngredient[],
  ...
  public updateRecipe(recipe: Recipe): Recipe {
    const recipeIndex = _.findIndex(this.recipes,
      (r) => r.id === recipe.id );
  ...
  public deleteRecipe(id: number): void {
    let recipeIndex = _.findIndex(this.recipes,
      (r) => r.id === id );
    if (recipeIndex !== -1)  {
